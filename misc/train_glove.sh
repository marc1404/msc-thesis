./vocab_count -verbose 2 -max-vocab 100000 -min-count 10 < train_glove.txt > vocab.txt
./cooccur -verbose 2 -symmetric 0 -window-size 10 -vocab-file vocab.txt -memory 8.0 -overflow-file tempoverflow < train_glove.txt > cooccurrence.bin
